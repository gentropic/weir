...
export function buildWeirTools({ store, cardFacets, ensureCards, app } = {}) {
  ...
  return { queryItems, getItem, listFacets, listSources, resolveLinks, resolverLog, reEnrich, setState, tag, unarchiveAll, catalogItem, catalogControl, reviewQueue, reviewItem, listProviderModels, setCatalog, stacksList, stacksRead, stacksWrite, stacksMove, stacksTag, stacksTrash };
}
