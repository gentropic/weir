    ...
    const view = new CM.EditorView({
      ...
      state: CM.EditorState.create({
        ...
        extensions: [
          ...
          // NB: no Mod-s binding here — the document-level onKey handles Cmd/Ctrl-S
          // (the keydown bubbles up from CM6), so binding it here too would double-fire
          // saveNoteEditor and create two notes on a first save.
